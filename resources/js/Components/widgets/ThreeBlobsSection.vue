      ...
      >
        ...
        <div class="blob-container">
          ...
          <svg
            ...
            class="blob-svg"
          >
              <path d="M146.309 327.8C30.7302 339.504 25.3817 265.827 8.3919 228.344C-18.3463 169.356 23.8826 30.9185 63.8586 6.05426C103.835 -18.8099 183.287 41.3092 263.738 35.7421C344.227 30.1724 328.002 133.376 294.22 189.379C266.237 235.767 316.207 272.877 285.226 298.854C254.244 324.831 201.276 322.234 146.309 327.8Z" fill="#F4F7FB"/>
